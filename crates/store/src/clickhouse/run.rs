...
impl From<&Run> for RunRow {
    fn from(r: &Run) -> Self {
        ...
        Self {
            ...
            experiment_id: r.experiment_id.map(Into::into).unwrap_or(uuid::Uuid::nil()),
...
impl From<RunRow> for Run {
    fn from(r: RunRow) -> Self {
        ...
        Self {
            ...
            experiment_id: if r.has_experiment {
...
impl RunWriter for ClickHouseRunStore {
...
impl RunReader for ClickHouseRunStore {
    ...
    async fn get_run(&self, id: &RunId) -> Result<Option<Run>, ReadError> {
